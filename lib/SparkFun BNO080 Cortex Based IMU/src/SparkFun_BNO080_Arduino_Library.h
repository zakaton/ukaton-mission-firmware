...
#define SENSOR_REPORTID_SIGNIFICANT_MOTION 0x12 // https://github.com/adafruit/Adafruit_BNO08x/blob/master/src/sh2.h#L108
#define SENSOR_REPORTID_STABILITY_CLASSIFIER 0x13
#define SENSOR_REPORTID_STABILITY_DETECTOR 0x1c
#define SENSOR_REPORTID_RAW_ACCELEROMETER 0x14
#define SENSOR_REPORTID_RAW_GYROSCOPE 0x15
#define SENSOR_REPORTID_RAW_MAGNETOMETER 0x16
#define SENSOR_REPORTID_SHAKE_DETECTOR 0x19 // https://github.com/adafruit/Adafruit_BNO08x/blob/master/src/sh2.h#L110
...
#define FRS_RECORDID_SIGNIFICANT_MOTION 0xE316 // https://github.com/adafruit/Adafruit_BNO08x/blob/master/src/sh2.h#L337
#define FRS_RECORDID_SHAKE_DETECTOR 0xE318		 // https://github.com/adafruit/Adafruit_BNO08x/blob/master/src/sh2.h#L339
...
public:
	BNO080()
	{
		shtpHeader = &shtpRawData[0];
		shtpData = &shtpRawData[BNO080_HEADER_LENGTH];
	}
	...
	uint32_t floatToQ(float floatingPointValue, uint8_t qPoint); // Given a Q value, converts fixed point floating to regular floating point number
	...
	void printPacket(uint8_t printBytes);
	...
	void enableStabilityDetector(uint16_t timeBetweenReports);
	void enableSignificantMotionDetector();
	void disableSignificantMotionDetector();
	void setAutoEnableSignificantMotionDetector(bool autoEnable);
	...
	uint8_t *shtpHeader;
	uint8_t *shtpData;
	uint8_t shtpRawData[MAX_PACKET_SIZE];
...
private:
	...
	// Significant Motion
public:
	unsigned long getLastTimeSignificantlyMoved();
	unsigned long getLastTimeStabilityDetectorTriggered();

private:
	unsigned long lastTimeSignificantlyMoved = 0;
	unsigned long lastTimeStabilityDetectorTriggered = 0;
	bool autoEnableSignificantMotion = false;
	bool didEnableSignificantMotion = false;
};