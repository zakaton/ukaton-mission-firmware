...
#define MAX1704x_CLONE_ADDRESS 0x32 // Unshifted I2C address. Becomes 0x6C for write and 0x6D for read.
...
public:
  ...
  bool begin(uint8_t deviceAddress = MAX1704x_ADDRESS, TwoWire &wirePort = Wire); // Returns true if module is detected
